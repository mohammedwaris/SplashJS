...
namespace splashjs.display {
    export class StageScaleMode {
        public static EXACT_FIT : string = "excat_fit";
...
namespace splashjs.render.media.iface {
    export interface ICameraRenderer extends splashjs.render.events.iface.IEventDispatcherRenderer {
        setMediaStream(mediaStream : splashjs.def.js.MediaStream);

        getMediaStream() : splashjs.def.js.MediaStream;
    }
}
namespace splashjs.render.media.iface {
...
namespace splashjs.display {
    export abstract class DisplayObject extends splashjs.events.EventDispatcher implements splashjs.display.iface.IDisplayObject {
        /*private*/ x : number;
...
namespace splashjs.render.application {
    export class StageOwnerRenderer extends splashjs.render.events.EventDispatcherRenderer implements splashjs.render.application.iface.IStageOwnerRenderer {
        ...
        public create() {
            let stageOwner : splashjs.application.iface.IStageOwner = <splashjs.application.iface.IStageOwner><any>super.getRenderObject();
...
namespace splashjs.render.media {
    export class CameraRenderer extends splashjs.render.events.EventDispatcherRenderer implements splashjs.render.media.iface.ICameraRenderer {
        /*private*/ mediaStream : splashjs.def.js.MediaStream;
        ...
        public static getCamera() : splashjs.media.iface.ICamera {
            let camera : splashjs.media.iface.ICamera = new splashjs.media.Camera();
            let cameraPromise : Promise<any> = <any>(eval("navigator.mediaDevices.getUserMedia({video: true});"));
            cameraPromise.then(((camera) => {
                return (mStream) => {
                    let mediaStream : Object = <Object>mStream;
                    console.info(<splashjs.def.js.MediaStream>mediaStream);
                    (<splashjs.render.media.iface.ICameraRenderer><any>camera.getRenderer()).setMediaStream(<splashjs.def.js.MediaStream>mediaStream);
                }
            })(camera)).catch((error) => {
                console.info(error);
            });
        ...
        public setMediaStream(mediaStream : splashjs.def.js.MediaStream) {
            this.mediaStream = mediaStream;
        }

        public getMediaStream() : splashjs.def.js.MediaStream {
...
namespace splashjs.layout {
    export abstract class Layout extends splashjs.display.InteractiveObject implements splashjs.layout.iface.ILayout {
        public constructor(id? : any) {
            if(((typeof id === 'string') || id === null)) {
                let __args = arguments;
                super(id);
...
namespace splashjs.render.media {
    export class SoundRenderer extends splashjs.render.display.DisplayObjectRenderer {
...
namespace splashjs.render.media {
    export class VideoRenderer extends splashjs.render.display.DisplayObjectRenderer {
        ...
        public attachCamera(camera : splashjs.media.iface.ICamera) {
            let mediaStream : splashjs.def.js.MediaStream = (<splashjs.render.media.iface.ICameraRenderer><any>camera.getRenderer()).getMediaStream();
...
namespace splashjs.controls {
    export abstract class BaseInput extends splashjs.controls.BaseText implements splashjs.controls.iface.IBaseInput {
        ...
        public setMaxChars(maxChars : number) {
            ...
            if(super.getRenderer() != null) (<splashjs.render.controls.iface.IBaseInputRenderer><any>super.getRenderer()).setMaxChars();
        }
        ...
        public setPlaceHolderText(placeHolderText : string) {
            ...
            if(super.getRenderer() != null) (<splashjs.render.controls.iface.IBaseInputRenderer><any>super.getRenderer()).setPlaceHolderText();
        }
        ...
        public render() {
            super.render();
            (<splashjs.render.controls.iface.IBaseInputRenderer><any>super.getRenderer()).setMaxChars();
            (<splashjs.render.controls.iface.IBaseInputRenderer><any>super.getRenderer()).setEditable();
            (<splashjs.render.controls.iface.IBaseInputRenderer><any>super.getRenderer()).setPlaceHolderText();
        }
    }
...
namespace splashjs.render.display {
    export class StageRenderer extends splashjs.render.display.DisplayObjectContainerRenderer implements splashjs.render.display.iface.IStageRenderer {
         ...
         */
        public setColor() {
            let color : splashjs.utils.iface.IColor = (<splashjs.display.iface.IStage><any>this.getRenderObject()).getColor();
...
namespace splashjs.render.controls {
    export abstract class BaseInputRenderer extends splashjs.render.controls.BaseTextRenderer implements splashjs.render.controls.iface.IBaseInputRenderer {
        ...
        public setPlaceHolderText() {
            let placeHolderText : string = (<splashjs.controls.iface.IBaseInput><any>super.getRenderObject()).getPlaceHolderText();
        ...
        public setMaxChars() {
            let maxChars : number = (<splashjs.controls.iface.IBaseInput><any>super.getRenderObject()).getMaxChars();
            if(maxChars >= 1) super.getDOMElement().setAttribute("maxLength", maxChars + "");
        }

        public setEditable() {
            let editable : boolean = (<splashjs.controls.iface.IBaseInput><any>super.getRenderObject()).getEditable();
