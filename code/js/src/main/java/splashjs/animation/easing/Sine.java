...
public class Sine {
	...
	public static final String EASE_IN = "sine_ease_in";
	public static final String EASE_OUT = "sine_ease_out";
	public static final String EASE_IN_OUT = "sine_ease_in_out";
