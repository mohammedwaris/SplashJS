...
public class Back {
	...
	public static final String EASE_IN = "back_ease_in";
	public static final String EASE_OUT = "back_ease_out";
	public static final String EASE_IN_OUT = "back_ease_in_out";
