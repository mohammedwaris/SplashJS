...
public class Elastic {
	...
	public static final String EASE_IN = "elastic_ease_in";
	public static final String EASE_OUT = "elastic_ease_out";
	public static final String EASE_IN_OUT = "elastic_ease_in_out";
