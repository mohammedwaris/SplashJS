...
(function (splashjs) {
    var Import = (function () {
        ...
        ;
        Import.clazz = function (clazz, packaze) {
            /* add */ (Import.className_$LI$().push(clazz) > 0);
            /* add */ (Import.packageName_$LI$().push(packaze) > 0);
        };
    ...
    (function (media) {
        var Video = (function (_super) {
            ...
            Video.prototype.dispatchEvent = function (event) {
                ...
                if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(event.getType(), splashjs.events.EventName.ABOUT_TO_BE_ADDED_TO_STAGE)) {
                }
                else if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(event.getType(), splashjs.events.Event.ADDED_TO_STAGE)) {
                }
                return val;
            };
            /**
    ...
    (function (display) {
        var Image = (function (_super) {
            ...
            Image.prototype.dispatchEvent = function (event) {
                ...
                else if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(event.getType(), splashjs.events.EventName.LOADED)) {
    ...
    (function (display) {
        var Stage = (function (_super) {
            ...
            Stage.prototype.dispatchEvent = function (event) {
                ...
                else if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(event.getType(), splashjs.events.EventName.STAGE_READY)) {
                    for (var i = 0; i < this.children.length; i++) {
                        {
                            var myChild = this.children[i];
                            myChild.getRenderer().setZIndex(i + "");
                ...
                else if ((function (o1, o2) { return o1.toUpperCase() === (o2 === null ? o2 : o2.toUpperCase()); })(event.getType(), splashjs.events.EventName.STAGE_RENDERED)) {
                }
                return _super.prototype.dispatchEvent.call(this, event);
            };
    ...
    (function (display) {
        ...
        (function (desktop) {
            var Stage = (function (_super) {
                __extends(Stage, _super);
                function Stage(stageOwnerName, width, height) {
                    return _super.call(this, stageOwnerName, width, height) || this;
                }
